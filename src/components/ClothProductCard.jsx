// components/ClothProductCard.js
const ClothProductCard = ({ product }) => {
    return (
      <div className="bg-gray-200 border border-gray-400 rounded-lg shadow-lg overflow-hidden hover:shadow-2xl transition-shadow duration-300">
        <div className="relative">
            ...
            <span className="absolute top-2 z-10 left-2 bg-pink-500 text-white text-xs font-bold px-3 py-1 rounded-full">
              Clothes
            </span>
